...
(function() {
  var DB, PolygonIndex, Result, SetIndex, TextIndex, TrieIndex, clone, empty;
  ...
  DB = (function() {
    ...
    DB.prototype.search = function(options, sortFn) {
      ...
      return ((function() {
        ...
        for (id in _ref) {
          _ = _ref[id];
          _results.push(clone(this.idLookup[id]));
        }
        return _results;
      }).call(this)).sort(sortFn);
    };

    DB.prototype.list = function(sortFn) {
      var id, object;
      if (sortFn == null) {
        sortFn = null;
      }
