...
(function() {
  var IDSet, SetIndex, TextIndex, blacklist, empty, natural, normalization_pattern, spaces;
  ...
  TextIndex = (function() {
    ...
    TextIndex.prototype.add = function(id, texts) {
      var text, tokens, word, _i, _j, _len, _len1;
      texts = texts instanceof Array ? texts : [texts];
    ...
    TextIndex.prototype.search = function(text) {
      var token, tokens;
      tokens = TextIndex.normalize(text).split(' ');
      return IDSet.intersect((function() {
